...
ui <- dashboardPage(title = "www.yonathananggraiwan.com",
      ...
      sidebarMenu(
        ...
        menuItem("Source Code", icon = icon("github"), href = "https://github.com/ayoung345"),
        menuItem("About Me", icon = icon("linkedin"), href = "https://www.linkedin.com/feed/?trk=guest_homepage-basic_sign-in-submit"),
